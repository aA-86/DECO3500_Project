...
$(document).ready(function($) {
    ...
    $(".blue-icon").click(function() {
        ...
        if (image_src == "/../asset/images/blue-icon-fill-thank.svg") {
            image.attr("src", "/../asset/images/blue-icon-thank.svg");
        } else {
            image.attr("src", "/../asset/images/blue-icon-fill-thank.svg");
    ...
    $(".purple-icon").click(function() {
        ...
        if (image_src == "/../asset/images/purple-icon-fill-thank.svg") {
            image.attr("src", "/../asset/images/purple-icon-thank.svg");
        } else {
            image.attr("src", "/../asset/images/purple-icon-fill-thank.svg");
            $(".notifications .thank-you-notification .message").text("I appreciate your feedback!");
            $(".notifications .thank-you-notification").css("display", "grid");
        }
    })
    ...
    $(".jc-icon").click(function() {
        ...
        if (image_src == "/../asset/images/jc-eye-fill-reminder.svg") {
            image.attr("src", "/../asset/images/jc-eye-reminder.svg");
        } else {
            image.attr("src", "/../asset/images/jc-eye-fill-reminder.svg");
    ...
    $(".km-icon").click(function() {
        ...
        if (image_src == "/../asset/images/km-eye-fill-reminder.svg") {
            image.attr("src", "/../asset/images/km-eye-reminder.svg");
        } else {
            image.attr("src", "/../asset/images/km-eye-fill-reminder.svg");
            $(".notifications .thank-you-notification .message").text("Sorry to bother! I really need feedback from you :)");
            $(".notifications .thank-you-notification").css("display", "grid");
        }
    })
